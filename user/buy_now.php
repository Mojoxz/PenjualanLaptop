    ...
    if ($bayar < $total) {
        ...
        try {
            ...
            if (tambah('tb_pembelian', $data_pembelian)) {
                ...
                $data_penjualan = [
                    'admin_id' => $admin_id, // Gunakan admin_id yang baru diambil
                    'tanggal' => date('Y-m-d H:i:s'),
                    'bayar' => $bayar,
                    'total' => $total,
                    'kembalian' => $kembalian
                ...
                if (tambah('tb_penjualan', $data_penjualan)) {
                    ...
                    if ($all_success) {
                        mysqli_commit($conn);
                        // Logging untuk debugging
                        error_log("Pembelian langsung berhasil disimpan dengan ID: $id_pembelian, Admin ID: $admin_id, User ID: $user_id");
